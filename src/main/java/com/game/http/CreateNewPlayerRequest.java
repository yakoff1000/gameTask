...
public class CreateNewPlayerRequest {
    ...
    public CreateNewPlayerRequest(){

    }

    public CreateNewPlayerRequest(String name, String title, Race race, Profession profession, Long birthday, Boolean banned , Integer experience) {
        this.name = name;
        this.title = title;
        this.race = race;
    ...
    public boolean equals(Object o) {
        ...
        CreateNewPlayerRequest that = (CreateNewPlayerRequest) o;
