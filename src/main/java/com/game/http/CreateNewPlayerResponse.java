...
public class CreateNewPlayerResponse {
    Long id;
    String name;
    String title;
    Race race;
    ...
    public CreateNewPlayerResponse() {
    }

    public CreateNewPlayerResponse(Long id, String name, String title, Race race, Profession profession, Long birthday, Boolean banned, Integer experience, Integer level, Integer untilNextLevel) {
        this.id = id;
        this.name = name;
        this.title = title;
        this.race = race;
    ...
    public boolean equals(Object o) {
        ...
        CreateNewPlayerResponse that = (CreateNewPlayerResponse) o;
